	...
	<div id="m-melanin-main-content">
        ...
        <g:each in="${blackListCn}" var="b" status="i">
	        <tr>
	              ...
	              <td class ="center"><a id="detail" href="${createLink(controller:'blackList',action:'viewBlacklistCn',params:[blacklistId:b.id])}" >Xem chi tiết</a></td>						
	        </tr>
	        </g:each>
			</tbody>
		</table>
