...
<html>
  ...
  <body>
     ...
     <div id="m-melanin-main-content">
      <g:form name="blacklistForm" class="form" action="detailBlacklist" style="margin-bottom:-15px">  		 		 
...
<%--                <td >${e.status}</td>              --%>
				<td class ="center"><a href="${createLink(controller:'admin',action:'detailBlacklist',params:[blId:i.id])}" >Xem chi tiết</a></td>				                                    
	        </tr>
	        </g:each>
	      </tbody>
	    </table>
