...
<html>
  <head>
    ...
    <title>Báo cáo đánh giá rủi ro hoạt động theo rủi ro cấp 3</title>
  </head>
  <body>
    <div id="m-melanin-tab-header">
			...
			<g:render plugin="melanin" template="/templates/m-melanin-breadcrum"
				model="${[
						...
						[href:createLink(controller:'report',action:'risklv3Report'),title:'Báo cáo đánh giá rủi ro hoạt động theo rủi ro cấp 3',label:'Báo cáo đánh giá rủi ro hoạt động theo rủi ro cấp 3']]
					]}"/>
    ...
    <div id="m-melanin-main-content">
       <g:form name="reportForm" class="form" action="risklv3Report">
    ...
    <table class="datatablesExport">
	        <thead>
	          <tr>
	            ...
	            <th width="45%" class ="center">Rủi ro level 3</th>
    ...
    <script type="text/javascript">
      ...
      $("#report-risklv3").closest('li').addClass('active');
        set_side_bar(true);
