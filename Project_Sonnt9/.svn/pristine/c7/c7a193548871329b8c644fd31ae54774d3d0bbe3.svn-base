		...
		<g:form method="post" name="detailBlacklistTSDB" id="detailBlacklistTSDB" controller="blackList" action="saveTsbdBlacklist"	enctype="multipart/form-data">
			<fieldset>
				...
				<ol class="form form-clear olCenter" id="incidentField">
					...
					<table class="tableControlCenter" style="border:0px !important">
						 <tr style="border:0px ;">
		        			<td style ="border:0px"><label style="margin-top: 10px !important" for="thongtinTsBL" class=" lableTableCenter">Thông tin nhận diện tài sản <font color="red">*</font> </label></td>		        			    			
		    			</tr>
		    			 <tr style="border:0px ;">
        					<td style ="border:0px"><input style= "width: 630px;margin-right: 20px" type= "text" id = "thongtinTsBL" name="thongtinTsBL" value="${blacklistTsbd?.thongtinTsBL}"  class = "controlTableCenter validate[required]"/></td>       					
    					</tr>
					</table>
					<table class="tableControlCenter" style="border:0px !important">
						 <tr style="border:0px ;">
					...
					<table class="tableControlCenter" style="border:0px !important">
						 <tr style="border:0px ;">
		        			<td style ="border:0px"><label style="margin-top: 10px !important" for="canhanTsBL" class=" lableTableCenter">Cá nhân/tổ chức liên quan <%--<font color="red">*</font> --%></label></td>
		        			<td style ="border:0px"><label for="cmtlqTsBL" class=" lableTableCenter">CMT/HC/ĐKKD/MST người liên quan <%--<font color="red">*</font> --%></label></td>
		        			<td style ="border:0px"><label style="margin-top: 10px !important" for="lydoTsBL" class=" lableTableCenter">Lý do liên quan <%--<font color="red">*</font> --%></label></td>		        			    			
		    			</tr>
		    			 <tr style="border:0px ;">
        					...
        					<td style ="border:0px"><input style="margin-right: 20px" type= "text" id = "lydoTsBL" name="lydoTsBL" value="${blacklistTsbd?.lydoTsBL}" class = "controlTableCenter "/></td>       					
    					</tr>
					</table>
					<table class="tableControlCenter" style="border:0px !important">
						 <tr style="border:0px ;">
