...
<ol class="form form-clear error-form" style="margin-top:-15px;">
    ...
    <li>
		<table class="tableControlCenter" style="border:0px !important;margin-top: 20px !important">
		    	...
		    	<tr style="border:0px ;">
        			<td style ="border:0px">
        					<g:select name="donvi1" id="donvi1" style="width: 190px;margin-right: 20px"
                                           from="${UnitDepart.executeQuery('from UnitDepart e where e.ord=1 and e.status>=0 order by e.code+0')}" 
                                           value="${params.donvi1}"
    ...
    <li>
        <table class="tableControlCenter" style="border:0px !important">
				<tr style="border:0px; padding-top: 20px">
		        	...
		        	<td style ="border:0px"><label for="fromDate" class=" lableTableCenter">Từ ngày nhâp/cập nhập </label></td>
		        	<td style ="border:0px"><label for="toDate" class=" lableTableCenter">Đến ngày nhập/cập nhập </label></td>
		    	...
		    	<tr style="border:0px ;">
        			...
        			<td style ="border:0px"><g:select style="width:190px;margin-right: 23px;" name="phanloaiDsBl" id="phanloaiDsBl" 
																	...
																	value="${phanloaiDsBl}" 
																	noSelection="${['':'Tất cả']}"/></td>
        			--%>
        			<td style ="border:0px">
        			<select name="phanloaiDsBl" style="width:190px;margin-right: 10px" class = "controlTableCenter validate[required]">
					<option value="1" ${phanloaiDsBl=='1'?'selected="true"':'' }> Blacklist</option>
					<option value="2" ${phanloaiDsBl=='2'?'selected="true"':'' }> Warning list</option>
					<option value="3" ${phanloaiDsBl=='3'?'selected="true"':'' }> Blocklist(Danh sách phong tỏa)</option>
					</select>	
					</td>
        			<td style ="border:0px">
