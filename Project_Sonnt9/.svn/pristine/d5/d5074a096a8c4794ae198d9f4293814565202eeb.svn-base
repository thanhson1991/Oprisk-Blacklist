  ...
  <body>
     ...
     <div id="m-melanin-main-content">
  	<sec:ifAllGranted roles="ROLE_GDTT_LEVEL2">
			<g:form name="reportForm" id="reportForm" class="form float-left" action="getErrorDisplayLevel2" >
	...
	<sec:ifAllGranted roles="ROLE_GDTT_LEVEL3">
			<g:form name="reportForm" id="reportForm" class="form float-left" action="getErrorDisplayLevel3" >
     			<g:if test="${flash.message}">
				<div id="flash-message" class="message info">${flash.message}</div>
      			</g:if>
       			<g:render template="../opError/errorSReportRutgon"/>
	...
	<sec:ifAllGranted roles="ROLE_GDTT_LEVEL4">
			<g:form name="reportForm" id="reportForm" class="form float-left" action="getErrorDisplayLevel4" >
     			<g:if test="${flash.message}">
				<div id="flash-message" class="message info">${flash.message}</div>
      			</g:if>
       			<g:render template="../opError/errorSReportRutgon"/>
...
<%--	            <th class ="center" width="150px">Tên đơn vị</th> 
    ...
    <%--          <td class ="center">
              ...
              --%>
                  	<sec:ifAnyGranted roles="ROLE_CVQLRR,ROLE_GDTT_LEVEL2">
			      		<td class ="center"><a href="${createLink(controller:'opError',action:'getErrorDetail',params:[id:e.id])}" >Xem</a></td>
					</sec:ifAnyGranted>
					
					<sec:ifNotGranted roles="ROLE_CVQLRR,ROLE_GDTT_LEVEL2">
 ...
 <script class="jsbin" src="http://datatables.net/download/build/jquery.dataTables.nightly.js"></script>
    <script type="text/javascript">
       $(document).ready(function(){
	        ...
	        $("#error-management").closest('li').addClass('active');//leftMenu
	        set_side_bar(true);
       });
