					...
					<table class="tableControlCenter"
						...
						<tr style="border: 0px; padding-top: 20px">
							...
							<td style="border: 0px"><label for="ngaycapCnBL"
								class=" lableTableCenter">Ngày cấp<font color="red">*</font>
							</label></td>
					...
					<table class="tableControlCenter"
						...
						<tr style="border: 0px; padding-top: 20px">
							<td style="border: 0px"><label for="tochucCnBL"
								class=" lableTableCenter">Tổ chức có liên quan<%--<font color="red">*</font>
							--%></label></td>
							<td style="border: 0px"><label for="masothueCnBL"
								class=" lableTableCenter">ĐKKD/Mã số thuế tổ chức liên
									quan<%--<font color="red">*</font> --%>
							</label></td>
							<td style="border: 0px"><label for="lydoCnBl"
								class=" lableTableCenter">Lý do liên quan <%--<font color="red">*</font> --%></label></td>
						</tr>
						<tr style="border: 0px;">
							<td style="border: 0px"><input
								style="margin-right: 20px; width: 210px;" type="text"
							...
							<td style="border: 0px"><input style="margin-right: 20px"
								...
								class="controlTableCenter " /></td>
							<td style="border: 0px"><input type="text" id="lydoCnBl"
								name="lydoCnBl" value="${blackListCn?.lydoCnBl}"
								class="controlTableCenter " /></td>
						</tr>
					</table>
					<table class="tableControlCenter"
