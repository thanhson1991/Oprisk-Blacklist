...
<html>
  <head>
    ...
    <title>Loại tài sản Blacklist</title>
  </head>
  <body>
     <div id="m-melanin-tab-header">
     	<div id="m-melanin-tab-header-inner">
			...
			model="${[
						...
						[href:createLink(controller:'opError',action:'reportList'),title:'Loại tài sản Blacklist',label:'Loại tài sản Blacklist']]
					]}"/>
     ...
     <div id="m-melanin-main-content">
      <g:form name="blacklistForm" class="form" action="addTaiSandbBlacklist" style="margin-bottom:-15px">  		 		 
...
<%--	          <th class="center">ID</th>	            --%>
	            <th class ="center" >Mã loại tài sản  </th>
	            <th class ="center">Tên loại tài sản </th> 
<%--	            <th class ="center" >Trạng thái</th>--%>
	        ...
	        <g:each in="${allTaiSanBlacklist}" var="i" >
...
<%--                <td >${e.status}</td>              --%>
				<td class ="center"><a href="${createLink(controller:'admin',action:'addTaiSandbBlacklist',params:[blId:i.id])}" >Xem chi tiết</a></td>				                                    
	        </tr>
	        </g:each>
	      </tbody>
	    </table>
