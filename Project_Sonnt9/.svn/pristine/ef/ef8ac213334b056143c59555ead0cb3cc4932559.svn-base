	    ...
	    %>
			...
			<fieldset>
				...
				<ol class="form form-clear olCenter" id="incidentField">
					...
					<table class="tableControlCenter" style="border: 0px !important; margin-top: 6px !important">
						<tr style="border: 0px; padding-top: 20px">
							<td style="border: 0px"><label for="tochucPnBL" class=" lableTableCenter">Cá nhân có liên quan<%--<font color="red">*</font>--%></label></td>
							<td style="border: 0px"><label for="hochieuPnBL" class=" lableTableCenter">CMT/hộ chiếu cá nhân liên quan<%--<font color="red">*</font> --%></label></td>
							<td style="border: 0px"><label for="lydoLqPnBL"  class=" lableTableCenter">Lý do liên quan <%--<font color="red">*</font> --%></label></td>
						</tr>
						<tr style="border: 0px;">
