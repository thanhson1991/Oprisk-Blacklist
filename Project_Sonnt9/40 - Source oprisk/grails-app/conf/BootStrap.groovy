...
//level 	
			...
			if(!MenuItem.findByName('blacklist-management'))
				new MenuItem(name:'blacklist-management',controller:'blackList',action:'getBlacklistDisplay',
					title:'',label:'Quản lý Blacklist',roles:'ROLE_CVQLRR').save(flush:true)
			if(!MenuItem.findByName('blacklist-management1'))
				new MenuItem(name:'blacklist-management1',controller:'blackList',action:'getBlacklistDisplayLevel1',
					title:'',label:'Quản lý Blacklist',roles:'ROLE_GDTT').save(flush:true)
			if(!MenuItem.findByName('blacklist-management2'))
				new MenuItem(name:'blacklist-management2',controller:'blackList',action:'getBlacklistDisplayLevel2',
					title:'',label:'Quản lý Blacklist',roles:'ROLE_GDTT_LEVEL2').save(flush:true)
			if(!MenuItem.findByName('blacklist-management3'))
				new MenuItem(name:'blacklist-management3',controller:'blackList',action:'getBlacklistDisplayLevel3',
					title:'',label:'Quản lý Blacklist',roles:'ROLE_GDTT_LEVEL3').save(flush:true)
			if(!MenuItem.findByName('blacklist-management4'))
				new MenuItem(name:'blacklist-management4',controller:'blackList',action:'getBlacklistDisplayLevel4',
					title:'',label:'Quản lý Blacklist',roles:'ROLE_GDTT_LEVEL4').save(flush:true)
