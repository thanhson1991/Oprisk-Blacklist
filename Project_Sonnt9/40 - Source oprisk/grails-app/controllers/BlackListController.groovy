...
class BlackListController {
	...
	def detailCaNhan = {
		...
		def blackListCn = BlackIndividual.createCriteria().list{
			...
			if(currentUserRole[0] == 'ROLE_GDTT_LEVEL2' && currentUserRole[0] == 'ROLE_GDTT'){
				eq('donvi_2',UnitDepart.get(errorMasterUser.tenDonVi2))
				
			}
			
			if(currentUserRole[0] =='ROLE_GDTT_LEVEL3' && currentUserRole[0] == 'ROLE_GDTT_LEVEL2' && currentUserRole[0] == 'ROLE_GDTT'){
