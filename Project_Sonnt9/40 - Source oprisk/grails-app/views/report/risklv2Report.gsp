...
<html>
  <head>
    ...
    <title>Báo cáo đánh giá rủi ro hoạt động theo rủi ro cấp 2</title>
  </head>
  <body>
    <div id="m-melanin-tab-header">
			...
			<g:render plugin="melanin" template="/templates/m-melanin-breadcrum"
				model="${[
						...
						[href:createLink(controller:'report',action:'risklv2Report'),title:'Báo cáo đánh giá rủi ro hoạt động theo rủi ro cấp 2',label:'Báo cáo đánh giá rủi ro hoạt động theo rủi ro cấp 2']]
					]}"/>
    ...
    <div id="m-melanin-main-content">
       <g:form name="reportForm" class="form" action="risklv2Report">
    ...
    <table class="datatablesExport">
	        <thead>
	          <tr>
	            ...
	            <th width="45%" class ="center">Rủi ro level 2</th>
	        ...
	        <tr>
	          ...
	          <td >${r.risk.name}</td>
                  <td id ="scoreA${i}" class ="center">${r.scores.A}</td>
                  <td id ="scoreB${i}" class ="center">${r.scores.B}</td>
                  <td class ="center">${r.scores.C}</td>
                  <td class ="center">${r.scores.D}</td>
                  <td id ="scoreAB${i}" class ="center">${r.scores.A+ r.scores.B}</td>
    ...
    <script type="text/javascript">
      $(document).ready(function(){       
          $("#report-risklv2").closest('li').addClass('active');
        set_side_bar(true);
