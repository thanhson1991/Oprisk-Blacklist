...
<body>
	...
	<div id="m-melanin-main-content">
		...
		<table class="sortDatatablesExport">
			<thead>
				<tr>
					<th class="center">Mã pháp nhân</th>
	        ...
	        <tr>
	              ...
	              <td class ="center"><a href="${createLink(controller:'blackList',action:'viewBlacklistPn',params:[blacklistId:p.id])}" >Xem chi tiết</a></td>						
	        </tr>
	        </g:each>
			</tbody>
		</table>
