...
<html>
  <head>
    ...
    <title>Phân loại đối tượng BlackList</title>
  </head>
  <body>
     <div id="m-melanin-tab-header">
     	<div id="m-melanin-tab-header-inner">
			...
			model="${[
						...
						[href:createLink(controller:'opError',action:'reportList'),title:'Phân loại đối tường blacklist',label:'Phân loại đối tượng blacklist']]
					]}"/>
     ...
     <div id="m-melanin-main-content">
      <g:form name="blacklistForm" class="form" action="addObjectBlacklist" style="margin-bottom:-15px">  		 		 
...
<%--	          <th class="center">ID</th>	            --%>
	            <th class ="center" >Mã đối tượng blacklist</th>
	            <th class ="center">Tên đối tượng blacklist</th> 
<%--	            <th class ="center" >Trạng thái</th>--%>
	        ...
	        <g:each in="${allObjectBlacklist}" var="i" >
...
<%--                <td >${e.status}</td>              --%>
				<td class ="center"><a href="${createLink(controller:'admin',action:'addObjectBlacklist',params:[blId:i.id])}" >Xem chi tiết</a></td>				                                    
	        </tr>
	        </g:each>
	      </tbody>
	    </table>
