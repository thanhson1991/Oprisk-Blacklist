...
<html>
  ...
  <body>
     ...
     <div id="m-melanin-main-content">
      <g:form name="masterUserCreate" class="form" action="viewErrorCheckInsert" style="margin-bottom:-15px">
...
<%--	          <th class="center">ID</th>	            --%>
	            ...
	            <th class ="center" >Mã kiểm tra</th>
	             <th class ="center">Tên kiểm tra</th>  
...
<%--                <td >${e.id}</td>--%>
                ...
                <td >${i.name}</td>
<%--                <td >${e.status}</td>              --%>
				<td class ="center"><a href="${createLink(controller:'admin',action:'viewErrorCheckUpdate',params:[id:i.id])}" >Xem chi tiết</a></td>				                                    
	        </tr>
	        </g:each>
	      </tbody>
	    </table>
