...
<html>
  <head>
    ...
    <title>Quản lý loại hành động</title>
  </head>
  <body>
     <div id="m-melanin-tab-header">
     	<div id="m-melanin-tab-header-inner">
			...
			model="${[
						...
						[href:createLink(controller:'admin',action:'reportList'),title:'Quản lý loại hành động',label:'Quản lý loại hành động']]
					]}"/>
     ...
     <div id="m-melanin-main-content">
      <g:form name="actionTypeForm" class="form" action="detailActionType" style="margin-bottom:-15px">  		 		 
...
<%--	          <th class="center">ID</th>	            --%>
	            <th class ="center" >Mã hành động</th>
	            <th class ="center">Tên hành động</th> 
...
<%--                <td >${e.status}</td>              --%>
				<td class ="center"><a href="${createLink(controller:'admin',action:'detailActionType',params:[actionTypeId:i.id])}" >Xem chi tiết</a></td>				                                    
	        </tr>
	        </g:each>
	      </tbody>
	    </table>
