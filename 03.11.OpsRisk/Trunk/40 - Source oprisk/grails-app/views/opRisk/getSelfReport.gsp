  ...
  <body>
    <div id="m-melanin-tab-header">
			...
			<g:render plugin="melanin" template="/templates/m-melanin-breadcrum"
				model="${[
						...
						[href:createLink(controller:'hierarchy',action:'index'),title:'Danh sách báo cáo tự đánh giá rủi ro',label:'Danh sách báo cáo tự đánh giá rủi ro']]
					]}"/>
      ...
      <ul class="m-melanin-vertical-navigation">
          ...
          <div id="m-melanin-main-content">
            <h3>Danh sách báo cáo tự đánh giá rủi ro</h3>
	      <table class="datatables">
	        ...
	        <tr>
	          <td class ="center">${p.createdBy.prop2}</td>
	          <td class ="center"><g:formatDate format="dd-MM-yyyy" date="${p.dateCreated}"/></td>
                  <td class ="center">${p.createdBy.fullname}</td>
                  <td class ="center"><g:message code="process${p.status}"/></td>
                  <td class ="center"><a href="${createLink(controller:'selfEvaluation',action:'viewEvaluationProcess',params:[id:p.id])}" >Xem chi tiết</a></td>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $("#selfReport").closest('li').addClass('active');
        set_side_bar(true);
