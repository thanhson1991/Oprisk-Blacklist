...
<html>
  <head>
    ...
    <title>Báo cáo đánh giá sự kiện tổn thất theo loại sự kiện</title>
  </head>
  <body>
    <div id="m-melanin-tab-header">
			...
			<g:render plugin="melanin" template="/templates/m-melanin-breadcrum"
				model="${[
						...
						[href:createLink(controller:'hierarchy',action:'index'),title:'Báo cáo đánh giá sự kiện tổn thất theo sự kiện',label:'Báo cáo đánh giá sự kiện tổn thất theo sự kiện']]
					]}"/>
    ...
    <div id="m-melanin-main-content">
       <g:form name="reportForm" class="form" action="eventReport">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        set_side_bar(true);
         $("#report-events").closest('li').addClass('active');
