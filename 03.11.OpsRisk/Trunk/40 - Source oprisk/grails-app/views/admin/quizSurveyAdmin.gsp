    ...
    <body>
        ...
        <g:render plugin="melanin" template="/templates/m-melanin-breadcrum"
				model="${[
						...
						[href:createLink(controller:'hierarchy',action:'index'),title:'Quản trị quiz',label:'Quản trị quiz']]
					]}"/>
			...
			<div class="clear"></div>
                    ...
                    <div id="m-melanin-left-sidebar">
                         <div id="m-melanin-left-sidebar">
                      <g:render template="../opRisk/quizsidebar"/>
		</div>
          ...
          <g:form name="surveyForm" class="break">
            ...
            <fieldset class="form float-left" style="width: 460px">
              ...
              <ol>
                ...
                <li><label for="minutes">Time(minute)</label>
                <g:textField name="minutes" class="e-xxl" value="${s?.minutes}" />
                </li>
            ...
            <fieldset class="survey break survey_admin">
              ...
              <ul>
                <g:each in="${s.questions}" var="q">
                  <li><survey:displayQuizQuestion question="${q}" admin="${true}"/>
                  </li>
                </g:each>
              </ul>
            </fieldset>
            ...
            $(document).ready(function(){    
              ...
              $(".delete_question").click(function(){
            	  ...
            	  jquery_confirm("Lưu phản hồi","Anh/chị đồng ý xóa câu hỏi này?",
                          function(){
            		  		document.location="${createLink(controller:'quizAdmin',action:'deleteQuestion')}/"+qid;
              ...
              $(".edit_question").click(function(){
                  var qid = $(this).attr('qid');
                  var question = $.getJSON('${createLink(controller:'quizAdmin',action:'getQuestion')}/'+qid,
              ...
              $("#questionDetailsDialog").dialog({
                  ...
                  buttons:{
                    'Đóng': function() {
                        $(this).dialog('close');
						document.location="${createLink(controller:'quizAdmin',action:'index')}/" +
                            $("#id").val();
                          // reload page here
                    },
                    'Lưu': function() {
                        ...
                        if($("#questionDetailsForm").validationEngine({returnIsValid:true,
                          ...
                          $.post('${createLink(controller:'quizAdmin',action:'saveQuestion')}',
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                set_side_bar(true);
               $("#quiz-management").closest('li').addClass('active');
