...
<html>
  ...
  <body>
     ...
     <div id="m-melanin-main-content">
      <g:form name="masterUserCreate" class="form" action="changeStatus" style="margin-bottom:-15px">
...
<%--	          <th class="center">ID</th>	            --%>
	            <th class ="center" >Mã trạng thái</th>
	            <th class ="center">Tên trạng thái</th>  
...
<%--                <td >${e.status}</td>              --%>
				<td class ="center"><a href="${createLink(controller:'admin',action:'changeStatus',params:[id:i.id])}" >Xem chi tiết</a></td>				                                    
	        </tr>
	        </g:each>
	      </tbody>
	    </table>
