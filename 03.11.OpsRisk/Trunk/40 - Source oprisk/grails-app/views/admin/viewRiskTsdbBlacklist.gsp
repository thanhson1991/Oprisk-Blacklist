...
<html>
  ...
  <body>
     <div id="m-melanin-tab-header">
     	<div id="m-melanin-tab-header-inner">
			...
			model="${[
						...
						[href:createLink(controller:'opError',action:'reportList'),title:'Quản lý danh sách blacklist',label:'Quản lý danh sách blacklist']]
					]}"/>
     ...
     <div id="m-melanin-main-content">
      <g:form name="blacklistForm" class="form" action="addRiskTsbdBlacklist" style="margin-bottom:-15px">  		 		 
...
<%--	          <th class="center">ID</th>	            --%>
	            <th class ="center" >Mã blacklist</th>
	            <th class ="center">Tên blacklist</th> 
<%--	            <th class ="center" >Trạng thái</th>--%>
	        ...
	        <g:each in="${RiskTsdbBlacklist}" var="i" >
...
<%--                <td >${e.status}</td>              --%>
				<td class ="center"><a href="${createLink(controller:'admin',action:'addRiskTsbdBlacklist',params:[blId:i.id])}" >Xem chi tiết</a></td>				                                    
	        </tr>
	        </g:each>
	      </tbody>
	    </table>
