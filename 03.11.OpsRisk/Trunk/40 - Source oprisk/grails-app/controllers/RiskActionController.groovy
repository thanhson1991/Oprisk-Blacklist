...
class RiskActionController {
	...
	def detail = {
		...
		def listActionType = ActionType.findAllByStatusGreaterThanEquals(0)
        def nowUser = User.findByUsername(springSecurityService.authentication.getName())
		render view:'/riskAction/detailRiskAction',model:[riskAction:riskAction,nowUser:nowUser]
	}
